...
function zenith_customize_preview_js() {
    wp_enqueue_style( 'zenith-customizer-preview-style', get_template_directory_uri() . '/assets/admin/css/customizer-preview.css', ZENITH_VERSION, null );
    wp_enqueue_script( 'zenith-customizer-preview-script', get_template_directory_uri() . '/assets/admin/js/customizer-preview.js', array ( 'jquery', 'customize-preview' ), ZENITH_VERSION, true );
}
add_action( 'customize_preview_init', 'zenith_customize_preview_js' );


function zenith_customize_controls_js() {
    wp_enqueue_script( 'zenith-customizer-control', get_template_directory_uri() . '/assets/admin/js/customizer-control.js', array ( 'jquery', 'customize-controls' ), ZENITH_VERSION, true );
    wp_enqueue_style( 'zenith-customizer-style', get_template_directory_uri() . '/assets/admin/css/customizer-alt.css', ZENITH_VERSION, null );
}
                ...
                'section_colors' => array (
                    ...
                    'options' => array (
                        ...
                        ZENITH_OPTIONS::COLOR_SKIN_PRIMARY => array(
                            ...
                            'choices'   => array(
                                '#00a0bc'       => __( 'Cool Peppermint', 'zenith' ),
