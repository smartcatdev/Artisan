...
if ( !function_exists( 'artisan_posted_on' ) ) :
    ...
    function artisan_posted_on() {
        ...
        $posted_on = sprintf(
                ...
                esc_html_x( 'Posted on %s', 'post date', 'artisan' ), '<a href="' . esc_url( get_permalink() ) . '" rel="bookmark">' . $time_string . '</a>'
        );
...
if ( !function_exists( 'artisan_posted_by' ) ) :

    /**
     * Prints HTML with meta information for the current author.
     */
    function artisan_posted_by() {
        $byline = sprintf(
                /* translators: %s: post author. */
                esc_html_x( 'by %s', 'post author', 'artisan' ), '<span class="author vcard"><a class="url fn n" href="' . esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ) . '">' . esc_html( get_the_author() ) . '</a></span>'
        );
...
if ( !function_exists( 'artisan_entry_footer' ) ) :
    ...
    function artisan_entry_footer() {
        ...
        if ( 'post' === get_post_type() ) {
            ...
            /* translators: used between list items, there is a space after the comma */
            $tags_list = get_the_tag_list( '', esc_html_x( ', ', 'list item separator', 'artisan' ) );
            if ( $tags_list ) {
            ...
            comments_popup_link(
                    sprintf(
                            wp_kses(
                                    ...
                                    __( 'Leave a Comment<span class="screen-reader-text"> on %s</span>', 'artisan' ), array (
                'span' => array (
                    'class' => array (),
                ),
                                    )
...
if ( !function_exists( 'artisan_post_thumbnail' ) ) :
     ...
     */
    function artisan_post_thumbnail() {
...
if ( !function_exists( 'artisan_pro\artisan_render_designer' ) ) :
    
    add_action( 'artisan_designer', 'artisan_render_designer', 10 );
    function artisan_render_designer() { ?>

        <span class="artisan_by">
            <?php esc_html_e( 'Design by', 'artisan' ); ?>
        </span>
 ...
 * @return void
 */
function artisan_render_masonry_wrap_open() { ?>
    ...
    <div class="masonry-card-blog">
        ...
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="<?php echo artisan_is_single_sidebar_active( 'blog' ) ? 'col-sm-9 col-md-9 col-lg-9' : 'col-sm-12'; ?>">
...
<?php }
add_action( 'artisan_blog_masonry_wrap_open', 'artisan_render_masonry_wrap_open');
 ...
 * @return void
 */
function artisan_render_masonry_wrap_close() { ?>
                        
                    </div>
                    
                    <div class="artisan-pagination-links">
                        <?php the_posts_pagination( array( 'mid_size' => 1 ) ); ?>
                    </div>

                </div>
                
                <?php artisan_output_side_sidebar( 'blog', 'right' ) ?>
...
<?php }
add_action( 'artisan_blog_masonry_wrap_close', 'artisan_render_masonry_wrap_close');
 ...
 * @return void
 */
function artisan_render_mosaic_wrap_open() { ?>
...
<?php }
add_action( 'artisan_blog_mosaic_wrap_open', 'artisan_render_mosaic_wrap_open');
 ...
 * @return void
 */
function artisan_render_mosaic_wrap_close() { ?>
...
<?php }
add_action( 'artisan_blog_mosaic_wrap_close', 'artisan_render_mosaic_wrap_close');
 ...
 * @return void
 */
function artisan_render_standard_wrap_open() { ?>
...
<?php }
add_action( 'artisan_blog_standard_wrap_open', 'artisan_render_standard_wrap_open');
 ...
 * @return void
 */
function artisan_render_standard_wrap_close() { ?>
...
<?php }
add_action( 'artisan_blog_standard_wrap_close', 'artisan_render_standard_wrap_close');
 ...
 */
function artisan_output_side_sidebar( $template = 'single', $location = 'right' ) {
    ...
    if ( $template == 'single' ) :
        ...
        if ( get_post_meta( get_the_ID(), ARTISAN_META::SIDEBAR_TEMPLATE, true ) != 'none' && get_post_meta( get_the_ID(), ARTISAN_META::SIDEBAR_LOCATION, true ) == 'sidebar-' . $location ) :

            if ( is_active_sidebar( get_post_meta( get_the_ID(), ARTISAN_META::SIDEBAR_TEMPLATE, true ) ) ) : ?>

                <div class="col-sm-3 col-md-3 col-lg-3">

                    <div class="artisan-landr-sidebar-wrap single <?php echo esc_attr( $location ); ?>">

                        <?php dynamic_sidebar( get_post_meta( get_the_ID(), ARTISAN_META::SIDEBAR_TEMPLATE, true ) ); ?>
        ...
        if ( is_active_sidebar( 'sidebar-blog-side' ) ) : ?>
            ...
            <div class="col-sm-3 col-md-3 col-lg-3">
                ...
                <div class="artisan-landr-sidebar-wrap archive <?php echo esc_attr( $location ); ?>">
 ...
 * @return void
 */
function artisan_render_edd_masonry_wrap_open() { ?>
...
<?php }
add_action( 'artisan_edd_masonry_wrap_open', 'artisan_render_edd_masonry_wrap_open');
 ...
 * @return void
 */
function artisan_render_edd_masonry_wrap_close() { ?>
                ...
                <?php if ( is_active_sidebar( 'sidebar-shop' ) ) : ?>
                    ...
                    <div class="col-sm-3 col-md-3 col-lg-3">
                        ...
                        <div class="artisan-landr-sidebar-wrap edd-shop">
...
<?php }
add_action( 'artisan_edd_masonry_wrap_close', 'artisan_render_edd_masonry_wrap_close');

function artisan_output_edd_product_gallery( $gallery = null, $location = 'desktop' ) {
