...
add_action( 'tgmpa_register', 'beyrouth_register_required_plugins' );


function beyrouth_register_required_plugins() {
    
    $plugins = array (

        array(
            'name'          => 'Beyrouth Features',
    ...
    $config = array (
        ...
        'strings'   => array(
            'menu_title'        => __( 'Theme Plugins', 'beyrouth' ),
            'page_title'        => __( 'Install the Beyrouth plugin to unlock the full customizable features of the theme', 'beyrouth' ),
