...
<div id="cart-panel">
    ...
    <div id="cart-panel-trigger">
        <span class="fas <?php echo esc_attr( get_theme_mod( ZENITH_OPTIONS::WOO_SLIDE_CART_TAB_ICON, ZENITH_DEFAULTS::WOO_SLIDE_CART_TAB_ICON ) ); ?>"></span>
        ...
        <div id="go-to-cart" href="/cart">
            ...
            <span id="cart-sidebar-quantity">
                <a class="cart-contents" href="<?php echo esc_url( wc_get_cart_url() ); ?>" title="<?php esc_attr_e( 'View your shopping cart', 'zenith' ); ?>">
                    ...
                    <?php echo esc_html( sprintf( _n( '%d item', '%d items', WC()->cart->get_cart_contents_count(), 'zenith' ), WC()->cart->get_cart_contents_count() ) ); ?> 
                    - 
