<footer id="colophon" class="site-footer footer-style-slim">
    ...
    <div id="slim-footer-wrap">
        ...
        <div id="slim-footer" class="<?php echo get_theme_mod( ZENITH_OPTIONS::FOOTER_CENTER_BRANDING, ZENITH_DEFAULTS::FOOTER_CENTER_BRANDING ) ? 'centered' : ''; ?> <?php echo get_theme_mod( ZENITH_OPTIONS::FOOTER_BOXED_CONTENT, ZENITH_DEFAULTS::FOOTER_BOXED_CONTENT ) && ! get_theme_mod( ZENITH_OPTIONS::FOOTER_CENTER_BRANDING, ZENITH_DEFAULTS::FOOTER_CENTER_BRANDING ) ? 'container' : ''; ?>">
            ...
            <div id="footer-social">
                ...
                <?php if ( get_theme_mod( ZENITH_OPTIONS::FOOTER_SHOW_SOCIAL, ZENITH_DEFAULTS::FOOTER_SHOW_SOCIAL ) ) : ?>
