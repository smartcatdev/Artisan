                        ...
                        <ul id="slim-header-a" class="slim-header-menu">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                ...
                                <a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>">
                                   <?php esc_html_e( 'Add a Left Menu?', 'zenith' ); ?>
                                </a>
                    ...
                    <?php if ( current_user_can( 'edit_theme_options' ) ) : ?>
                        ...
                        <ul id="slim-header-b" class="slim-header-menu">
                            ...
                            <li class="menu-item menu-item-type-custom menu-item-object-custom">
                                ...
                                <a href="<?php echo esc_url( admin_url( 'nav-menus.php' ) ); ?>">
                                   <?php esc_html_e( 'Add a Right Menu?', 'zenith' ); ?>
                                </a>
                    ...
                    <div class="navbar-social">
                        ...
                        <a id="split-social-trigger" class="navbar-icon">
                            <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="20" height="20" viewBox="0 0 20 20">
                                <path fill="<?php echo esc_attr( get_theme_mod( ZENITH_OPTIONS::NAVBAR_FG_COLOR, ZENITH_DEFAULTS::NAVBAR_FG_COLOR ) ); ?>" d="M10.707 10.5l5.646-5.646c0.195-0.195 0.195-0.512 0-0.707s-0.512-0.195-0.707 0l-5.646 5.646-5.646-5.646c-0.195-0.195-0.512-0.195-0.707 0s-0.195 0.512 0 0.707l5.646 5.646-5.646 5.646c-0.195 0.195-0.195 0.512 0 0.707 0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146l5.646-5.646 5.646 5.646c0.098 0.098 0.226 0.146 0.354 0.146s0.256-0.049 0.354-0.146c0.195-0.195 0.195-0.512 0-0.707l-5.646-5.646z"></path>
                            </svg>
                        </a>
