...
<div id="zenith-custom-header" class="zenith_parallax" data-plx-img="<?php echo esc_url( $header_image ); ?>">

    <div id="custom-header-overlay" class="<?php echo get_theme_mod( ZENITH_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_STYLE, ZENITH_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_STYLE ) == 'no' ? '' : esc_attr( get_theme_mod( ZENITH_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_STYLE, ZENITH_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_STYLE ) ); ?>">
    </div>
