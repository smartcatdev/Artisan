...
<div id="artisan-custom-header" class="marquee-header social artisan_parallax" data-plx-img="<?php echo esc_url( $header_image ); ?>">

    <div id="custom-header-overlay" class="<?php echo get_theme_mod( ARTISAN_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_STYLE, ARTISAN_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_STYLE ) == 'no' ? 'no' : esc_attr( get_theme_mod( ARTISAN_OPTIONS::CUSTOM_HEADER_COLOR_LAYER_STYLE, ARTISAN_DEFAULTS::CUSTOM_HEADER_COLOR_LAYER_STYLE ) ); ?>">
    </div>
    ...
    <div id="custom-header-content" class="social-header" data-stellar-offset-parent="true">
        ...
        <div class="marquee">
            ...
            <div class="marquee-inner">
                ...
                <?php if ( get_theme_mod( ARTISAN_OPTIONS::SOCIAL_HEADER_SHOW_SOCIAL, ARTISAN_DEFAULTS::SOCIAL_HEADER_SHOW_SOCIAL ) ) : ?>
        ...
        <?php if ( get_theme_mod( ARTISAN_OPTIONS::SOCIAL_HEADER_SHOW_SCROLL_TAB, ARTISAN_DEFAULTS::SOCIAL_HEADER_SHOW_SCROLL_TAB ) ) : ?>
