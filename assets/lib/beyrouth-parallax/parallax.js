jQuery(document).ready( function( $ ) {
    ...
    /**
     * Custom Parallax Library for Beyrouth
     * 
     * Proper Parallax
     */
    ...
    function parallaxImages() {
        ...
        var plx = document.getElementsByClassName('beyrouth_parallax');
        ...
        for(i=0;i<plx.length;i++){
            ...
            if (scrolled + win_height_padded >= offsetTop) {
                ...
                if (plxImg) {
                    ...
                    plxImg.style.top = (singleScroll / beyrouth_local_parallax.intensity_value) + "px";
                }
            }
        }
    }
